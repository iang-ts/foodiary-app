...
import { formatSeconds } from "@ui/styles/utils/formatSeconds";
...
export function Actions({
  ...
  }, [recordingTimeInSeconds, onStartRecording])
  ...
  if (state === 'idle') {
    return (
      <>
        <Button size="icon" variant="neutral" rippleStyle="light" onPress={onStartRecording}>
  ...
  if (state === 'recording') {
    return (
      <>
        <Button size="icon" variant="neutral" rippleStyle="light" onPress={onStopRecording}>
          <SquareIcon
            size={20}
